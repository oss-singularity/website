...
| [Commons promotion](release-commons-promotion.md) | The reviewed worker promotion procedure: inherited bindings, durable intent, single-attempt mutations, live acceptance and retained rollback; current state and next slices. |
