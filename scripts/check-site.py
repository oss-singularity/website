...
def required_files(actual: set[str], read) -> set[str]:
    required = {
        ...
        "data/synthetic-delivery-artifact.json",
        ...
        "assets/scripts/observatory-motion-v1.js", "assets/styles/observatory-motion-v1.css",
        ...
        "assets/scripts/projects-deliveries-v1.js",
    }
