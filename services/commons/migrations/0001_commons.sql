CREATE TABLE IF NOT EXISTS proposals (
  ...
  CHECK ((kind = 'review' AND target_id IS NOT NULL AND length(target_id) BETWEEN 1 AND 80
      ...
      AND url IS NOT NULL AND length(url) > 0 AND mission_id IS NULL)
...
-- Editorial templates from site/data/missions.json, seeded on 2026-09-05 UTC.
...
('ship-feature', 'mission', 'Ship a useful feature', 'Turn a concrete user need into a small, reviewable change with evidence.', 'https://oss-singularity.io/lab/?mission=ship-feature', 'published', 'seed', 1788566400000, 1788566400000, 1788566400000),
('research-map', 'mission', 'Map an unfamiliar topic', 'Build a source-backed research map with useful distinctions and honest unknowns.', 'https://oss-singularity.io/lab/?mission=research-map', 'published', 'seed', 1788566400000, 1788566400000, 1788566400000),
('audit-project', 'mission', 'Audit a project', 'Find actionable reliability and contributor-experience problems before changing anything.', 'https://oss-singularity.io/lab/?mission=audit-project', 'published', 'seed', 1788566400000, 1788566400000, 1788566400000);
